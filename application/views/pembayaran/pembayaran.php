...
<div class="container">
    <div class="row  pt-2 pb-2">
        <div class="col-md-2 pt-6 text-center">
            ...
            <a class="text-center" href="<?= site_url('belanja/tampil_cart'); ?>"><br><br>KERANJANG BELANJA</a>
        </div>
        <div class="col-1"></div>
        <div class="col-md-2 pt-6 text-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="cart-page-heading">
                        <h2 style="color:grey;">LANGKAH 2 -</h2>
                        <h3> RINCIAN BELANJA DAN ALAMAT PENGIRIMAN</h3>
            ...
            <div class="cart-page-heading">
                <h2 style="color:grey;">LANGKAH 4 -</h2>
                <h3> TRANSFER</h3>
