                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="harga_brg"
                                                        value="<?php echo $barang->harga_barang ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="grosir"
                                                        value="<?php echo $barang->harga_grosir ?>" />
                                            </div>
                                        </div>
                                            <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="file" name="gambar"
                                                        placeholder="Gambar Barang" value="<?php echo $barang->gambar ?>" />
                                                </div>
                                        </div>
                                        <div class=" col-3">
                                        <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="stock"
                                                        placeholder="Harga" value="<?php echo $barang->stock ?>" />
                                                </div>
                                        </div>
                                        <div class=" col-3">
                                        <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="diskon"
                                                        placeholder="%" value="<?php echo $barang->diskon ?>" />
                                                </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="deskripsi"
                                                        placeholder="Deskripsi" value="<?php echo $barang->deskripsi ?>" />
                                                </div>
                                                </div>
                                            </div>
                                        </div>
