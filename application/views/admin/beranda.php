    ...
    <div class="container-fluid">
      ...
      <ul class="nav align-items-center d-md-none">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              ...
              <img alt="Image placeholder"
                                        src="<?php echo base_url(); ?>('assets/img/brand/usericon.png'); ?>">
                                </span>
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="<?php echo base_url(); ?>('login_admin/logout'); ?>" class="dropdown-item">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <a class=" nav-link active " href=" <?php echo base_url(); ?>/index.html"> <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
